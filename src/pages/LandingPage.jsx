    ...
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
       ...
       <img src="./landing2.png" alt="pregnant girl"/>
        ...
        <div class="place-self-center lg:col-span-7">
            ...
            <a href="#" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-pink-900 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Go to site
            </a> 
        </div>
