    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
               ...
               <a href='https://www.plannedparenthood.org/learn/pregnancy' target="_blank" > <h3 class="mb-2 text-xl font-bold dark:text-white">Pregnancy Journey</h3></a>
            ...
            <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Hospitals</h3>
            ...
            <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Shelters</h3>
            ...
            <div>
               ...
               <a href='https://mumsvillage.com/pregnancy-parenting/serah-adoption-agencies-kenya/' target='blank'><h3 class="mb-2 text-xl font-bold dark:text-white">Adoption Agencies</h3></a>
            ...
            <div>
                ...
                <h3 class="mb-2 text-xl font-bold dark:text-white">Counselling</h3>
            ...
            <div>
               ...
               <a href='https://www.plannedparenthood.org/learn/health-and-wellness/sexual-and-reproductive-anatomy' target='blank'><h3 class="mb-2 text-xl font-bold dark:text-white">Sexual Education & family planning</h3></a>
