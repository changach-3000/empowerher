          ...
          <div className="h-full flex flex-col items-center justify-center xl:flex-row">
            <div className="w-full max-w-xl xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4 text-base text-pink-900 md:text-lg">
                Feel free to contribute any amount you're comfortable with to
                support the cause of your choice, whether it's hospitals,
                shelters, or individual mothers. Your generosity makes a
                difference.
              </p>
            </div>
